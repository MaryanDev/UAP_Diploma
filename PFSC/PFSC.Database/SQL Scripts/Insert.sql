...
• Доставимо під самі двері', 1, 49.7975535, 24.0129542, 'www.media.biz.ua', N'ПРАЙД МЕДІА, ТОВ', 1),
...
Всі види післядрукарської обробки: порізка, біговка, ламінування, перфорація, скріплення скобами та на пружину.', 2, 49.8198671, 24.0155795, 'www.cifradruk.com.ua', N'ЛЬВІВСЬКА ЦИФРОВА ДРУКАРНЯ, ТОВ', 1),
...
- металеві етикетки.', 3, 49.8307614, 23.9668733, 'www.sp-ekko.com.ua', N'ЕККО, ТОВ', 1),
...
- Вебдизайн та розробка веб-сайтів', 2, 49.851373, 24.0207953, 'www.leosvit.com', N'ЛЕОСВІТ, РЕКЛАМНА КОМПАНІЯ', 1),
...
- висока якість друку;
- оперативність;
- індивідуальний підхід до кожного клієнта', 4, 49.8087493, 24.0129304, 'www.levko.com.ua', N'ЛЕВКО, ДРУКАРНЯ', 1)
